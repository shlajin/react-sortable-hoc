!(function(e, t) {
  ...
  function k(e, t) {
    e.style[''.concat(I, 'Transform')] =
      null == t ? '' : 'translate3d('.concat(t.x, 'px,').concat(t.y, 'px,0)');
  }
  function E(e, t) {
    e.style[''.concat(I, 'TransitionDuration')] =
      null == t ? '' : ''.concat(t, 'ms');
  }
  function W(e, t) {
    for (; e; ) {
  ...
  function K(e, t) {
    ...
    if (e) {
      ...
      return e.parentNode === t ? o : K(e.parentNode, t, o);
    }
  }
  function G(e) {
    var t = e.lockOffset,
  ...
  function z(t) {
    ...
    return (
      (n = e = (function(e) {
        function i() {
          ...
          for (var n = arguments.length, o = new Array(n), r = 0; r < n; r++)
            o[r] = arguments[r];
          return (
            (t = p(this, (e = y(i)).call.apply(e, [this].concat(o)))),
            l(h(h(t)), 'wrappedInstance', a.createRef()),
            t
          );
        }
        return (
          ...
          d(i, [
            {
              ...
              value: function() {
                this.wrappedInstance.current.sortableHandle = !0;
              },
            },
            {
            ...
            },
            {
              ...
              value: function() {
                return a.createElement(
                  t,
                  s({ref: this.wrappedInstance}, this.props),
                );
              },
            },
          ]),
      ...
      l(e, 'displayName', L('sortableHandle', t)),
      n
    );
  }
  function $(e) {
  ...
  var J = (function() {
    function n(e, t) {
      c(this, n), (this.container = e), (this.onScrollCallback = t);
    }
    return (
      d(n, [
        {
  ...
  var Q = {
    ...
    Z = {lift: [X], drop: [X], cancel: [B], up: [Y, U], down: [V, F]},
    ee = {
      axis: 'y',
      disableAutoscroll: !1,
      distance: 0,
      ...
      shouldCancelStart: function(e) {
        return (
          -1 !==
            [q.Input, q.Textarea, q.Select, q.Option, q.Button].indexOf(
              e.target.tagName,
            ) ||
    ...
    te = Object.keys(Q);
  var ne = a.createContext({manager: {}});
  function oe(t) {
    var e,
      n,
      r =
    ...
    return (
      (n = e = (function(e) {
        function o(e) {
          var R;
          c(this, o),
            (R = p(this, y(o).call(this, e))),
            l(h(h(R)), 'state', {}),
            l(h(h(R)), 'handleStart', function(e) {
              var t = R.props,
                n = t.distance,
                o = t.shouldCancelStart;
              if (2 !== e.button && !o(e)) {
                (R.touched = !0), (R.position = H(e));
                var r,
                  i = W(e.target, function(e) {
            ...
            l(h(h(R)), 'nodeIsChild', function(e) {
              return e.sortableInfo.manager === R.manager;
            }),
            l(h(h(R)), 'handleMove', function(e) {
              var t = R.props,
                n = t.distance,
                o = t.pressThreshold;
              if (
                          ...
                          var e,
                            ...
                            u =
                              ...
                              (o = window.getComputedStyle(n)).display
                                ...
                                : {x: 0, y: 0}),
                            d = R.scrollContainer.getBoundingClientRect(),
            ...
            l(h(h(R)), 'handleSortMove', function(e) {
            ...
            l(h(h(R)), 'handleSortEnd', function(e) {
              var t = R.props,
            ...
            l(h(h(R)), 'onAutoScroll', function(e) {
              (R.translate.x += e.left),
                (R.translate.y += e.top),
                R.animateNodes();
            }),
            l(h(h(R)), 'handleKeyDown', function(e) {
              var t = e.keyCode,
                n = R.props,
            ...
            l(h(h(R)), 'keyMove', function(e) {
              ...
              if (!(o < 0 || n < o)) {
                ...
                var i,
                  ...
                  u = c.node,
                  d = R.containerScrollDelta,
                  f = c.boundingClientRect || j(u, d),
            ...
            l(h(h(R)), 'keyDrop', function(e) {
              R.handleSortEnd(e),
                R.initialFocusedNode && R.initialFocusedNode.focus();
            }),
            l(h(h(R)), 'handleKeyEnd', function(e) {
              R.manager.active && R.keyDrop(e);
            }),
            l(h(h(R)), 'isValidSortingTarget', function(e) {
              ...
              value: function() {
                ...
                Promise.resolve(e).then(function(e) {
                  ...
                  (n.contentWindow = 'function' == typeof t ? t() : t),
                    ...
                    (n.autoScroller = new J(n.scrollContainer, n.onAutoScroll)),
                    Object.keys(n.events).forEach(function(t) {
                      return N[t].forEach(function(e) {
                        return n.container.addEventListener(e, n.events[t], {
                          passive: !1,
                        });
                      });
                    }),
                ...
                if (
                  ...
                  var f = (function(e) {
                      ...
                      var i = b(r, 2),
                        ...
                        s = i[1];
                      return [
                        G({height: t, lockOffset: a, width: n}),
                        G({height: t, lockOffset: s, width: n}),
                      ];
              ...
              value: function() {
                ...
                for (var d = 0, f = a.length; d < f; d++) {
                  var h = a[d].node,
                    ...
                    S = a[d].edgeOffset;
                  S ||
                    ((S = K(h, this.container)),
                    (a[d].edgeOffset = S),
                    c && (a[d].boundingClientRect = j(h, r)));
                  var O = d < a.length - 1 && a[d + 1],
                    C = 0 < d && a[d - 1];
                  O &&
                    !O.edgeOffset &&
                    ((O.edgeOffset = K(O.node, this.container)),
                    c && (O.boundingClientRect = j(O.node, r))),
                    p !== this.index
                      ? (t && E(h, t),
                        this.axis.x
                          ? this.axis.y
            ...
            },
            {
              ...
              value: function() {
                return a.createElement(
                  ...
                  a.createElement(
                    t,
                    s({ref: this.wrappedInstance}, T(this.props, te)),
                  ),
                );
              },
            },
      ...
      l(e, 'displayName', L('sortableList', t)),
      l(e, 'defaultProps', ee),
      l(e, 'propTypes', Q),
      n
    );
  ...
  function ae(t) {
    ...
    return (
          ...
          d(i, [
            ...
            },
            {
              ...
              value: function() {
                var e = this.props,
                  ...
                  n = e.disabled,
                  o = e.index,
                  r = this.wrappedInstance.current;
                (r.sortableInfo = {
                  collection: t,
                  disabled: n,
                  index: o,
            ...
            },
            {
              ...
              value: function() {
                return a.createElement(
                  t,
                  s({ref: this.wrappedInstance}, T(this.props, ie)),
                );
              },
            },
          ]),
      ...
      l(e, 'displayName', L('sortableElement', t)),
      l(e, 'contextType', ne),
      l(e, 'propTypes', re),
      l(e, 'defaultProps', {collection: 0}),
      n
    );
  }
