!(function(e, t) {
  'object' == typeof exports && 'undefined' != typeof module
    ? t(exports, require('react'), require('react-dom'), require('prop-types'))
    : 'function' == typeof define && define.amd
    ? define(['exports', 'react', 'react-dom', 'prop-types'], t)
    : t(((e = e || self).SortableHOC = {}), e.React, e.ReactDOM, e.PropTypes);
})(this, function(e, a, s, t) {
  'use strict';
  function n(e, t) {
  ...
  function E(e, t) {
    e.style[''.concat(k, 'Transform')] =
      null == t ? '' : 'translate3d('.concat(t.x, 'px,').concat(t.y, 'px,0)');
  }
  function W(e, t) {
    e.style[''.concat(k, 'TransitionDuration')] =
      null == t ? '' : ''.concat(t, 'ms');
  }
  function P(e, t) {
    for (; e; ) {
  ...
  function $(t) {
    ...
    return (
      (n = e = (function(e) {
        function i() {
          ...
          for (var n = arguments.length, o = new Array(n), r = 0; r < n; r++)
            o[r] = arguments[r];
          return (
            (t = y(this, (e = g(i)).call.apply(e, [this].concat(o)))),
            c(p(p(t)), 'wrappedInstance', a.createRef()),
            t
          );
        }
        return (
          ...
          f(i, [
            ...
            },
            {
              ...
              value: function() {
                ...
                return a.createElement(t, l({ref: e}, this.props));
              },
            },
          ]),
          i
      ...
      c(e, 'displayName', j('sortableHandle', t)),
      n
    );
  }
  function J(e) {
  ...
  var Q = (function() {
    function n(e, t) {
      d(this, n), (this.container = e), (this.onScrollCallback = t);
    }
    return (
      f(n, [
        {
        ...
        },
        {
          ...
          value: function(e) {
            var t = this,
              ...
              y = u.scrollWidth,
              g = 0 === f,
              v = p - f - u.clientHeight == 0,
              m = 0 === h,
              x = y - h - u.clientWidth == 0;
            n.y >= r.y - a / 2 && !v
              ? ((s.y = 1), (l.y = d * Math.abs((r.y - a / 2 - n.y) / a)))
              : n.x >= r.x - i / 2 && !x
              ? ((s.x = 1), (l.x = c * Math.abs((r.x - i / 2 - n.x) / i)))
              : n.y <= o.y + a / 2 && !g
              ? ((s.y = -1), (l.y = d * Math.abs((n.y - a / 2 - o.y) / a)))
              : n.x <= o.x + i / 2 &&
                !m &&
  ...
  var Z = {
    ...
    ee = {lift: [U], drop: [U], cancel: [X], up: [F, Y], down: [q, V]},
    te = {
      axis: 'y',
      disableAutoscroll: !1,
      distance: 0,
    ...
    ne = Object.keys(Z);
  var oe = a.createContext({manager: {}});
  function re(t) {
    var e,
      n,
      r =
    ...
    return (
      (n = e = (function(e) {
        function o(e) {
          var R;
          d(this, o),
            (R = y(this, g(o).call(this, e))),
            c(p(p(R)), 'state', {}),
            c(p(p(R)), 'handleStart', function(e) {
              var t = R.props,
                n = t.distance,
                o = t.shouldCancelStart;
              if (2 !== e.button && !o(e)) {
                (R.touched = !0), (R.position = K(e));
                var r,
                ...
                if (
                  ...
                  if (a && !P(e.target, J)) return;
                  (R.manager.active = {collection: c, index: l}),
            ...
            c(p(p(R)), 'nodeIsChild', function(e) {
              return e.sortableInfo.manager === R.manager;
            }),
            c(p(p(R)), 'handleMove', function(e) {
              var t = R.props,
                n = t.distance,
                o = t.pressThreshold;
              if (
                    ...
                    if (r) {
                      var e = function() {
                          var e,
                            ...
                            d =
                              ...
                              (o = window.getComputedStyle(n)).display
                                ? {x: L(o.gridColumnGap), y: L(o.gridRowGap)}
                                : {x: 0, y: 0}),
                            u = R.scrollContainer.getBoundingClientRect(),
                            f = b({index: l, node: T, collection: I});
                          if (
                            ((R.node = T),
                            (R.margin = c),
                            (R.gridGap = d),
                            ...
                            (R.boundingClientRect = T.getBoundingClientRect()),
                            (R.containerBoundingRect = u),
                            (R.index = l),
                            (R.newIndex = l),
                            (R.axis = {
                              x: 0 <= x.indexOf('x'),
                            ...
                            (R.helper = R.helperContainer.appendChild(
                              ...
                              (a = (r = T).querySelectorAll(i)),
                              (s = r.cloneNode(!0)),
                              A(s.querySelectorAll(i)).forEach(function(e, t) {
                          ...
                          w &&
                            ...
                            (R.listenerNode = E.touches ? T : R.contentWindow),
                            k
                            ...
                            R.setState({sorting: !0, sortingIndex: l}),
                            O &&
                              O(
                                {
                                  node: T,
                        ...
                        o = (function() {
                          if ('function' == typeof n) {
                            ...
                            var e = (function(e, t) {
                              ...
                              function(e, t) {
                                if (
                                  ((R._awaitingUpdateBeforeSortStart = !1), e)
                                )
                                  throw t;
                                return t;
                              },
            ...
            c(p(p(R)), 'handleSortMove', function(e) {
            ...
            c(p(p(R)), 'handleSortEnd', function(e) {
              var t = R.props,
              ...
              R.listenerNode &&
                ...
                n &&
                  R.sortableGhost &&
                  M(R.sortableGhost, {opacity: '', visibility: ''});
              for (var l = 0, c = s.length; l < c; l++) {
                var d = s[l],
                  u = d.node;
                (d.edgeOffset = null),
                  E(u, (d.boundingClientRect = null)),
                  W(u, null),
                  (d.translate = null);
              }
            ...
            c(p(p(R)), 'onAutoScroll', function(e) {
              (R.translate.x += e.left),
                (R.translate.y += e.top),
                R.animateNodes();
            }),
            c(p(p(R)), 'handleKeyDown', function(e) {
              var t = e.keyCode,
                n = R.props,
              ...
              (R.manager.active && !R.manager.isKeySorting) ||
                !(
                  R.manager.active ||
                  (i.lift.includes(t) && !o(e) && R.isValidSortingTarget(e))
                ) ||
                (e.stopPropagation(),
                e.preventDefault(),
                i.lift.includes(t) && !R.manager.active
                  ? R.keyLift(e)
                  : i.drop.includes(t) && R.manager.active
                  ? R.keyDrop(e)
                  : i.cancel.includes(t)
                  ? ((R.newIndex = R.manager.active.index), R.keyDrop(e))
                  : i.up.includes(t)
                  ? R.keyMove(-1)
                  : i.down.includes(t) && R.keyMove(1));
            }),
            c(p(p(R)), 'keyLift', function(e) {
              var t = e.target,
                n = P(t, function(e) {
                  return null != e.sortableInfo;
                }).sortableInfo,
            ...
            c(p(p(R)), 'keyMove', function(e) {
              ...
              if (!(o < 0 || n < o)) {
                ...
                var i,
                  ...
                  d = c.node,
                  u = R.containerScrollDelta,
                  f = c.boundingClientRect || H(d, u),
                  h = c.translate || {x: 0, y: 0},
                  p = f.top + h.y - u.top,
                  y = f.left + h.x - u.left,
                  g = r < o,
                  v = g && R.axis.x ? d.offsetWidth - R.width : 0,
                  m = g && R.axis.y ? d.offsetHeight - R.height : 0;
                R.handleSortMove({
                  pageX: y + v,
                  pageY: p + m,
            ...
            c(p(p(R)), 'keyDrop', function(e) {
              R.handleSortEnd(e),
                R.initialFocusedNode && R.initialFocusedNode.focus();
            }),
            c(p(p(R)), 'handleKeyEnd', function(e) {
              R.manager.active && R.keyDrop(e);
            }),
            c(p(p(R)), 'isValidSortingTarget', function(e) {
          ...
          return (
            ...
            (R.manager = n),
            (R.wrappedInstance = a.createRef()),
            (R.sortableContextValue = {manager: n}),
            (R.events = {
              end: R.handleEnd,
              move: R.handleMove,
              start: R.handleStart,
        ...
        return (
          ...
          f(o, [
            ...
            },
            {
              ...
              value: function() {
                var e = this.props,
                  ...
                  s = this.offsetEdge.left + this.translate.x + r.left,
                  l = this.offsetEdge.top + this.translate.y + r.top,
                ...
                for (var u = 0, f = a.length; u < f; u++) {
                  var h = a[u].node,
                    ...
                    b = c && p < this.index && d <= p,
                    w = {x: 0, y: 0},
                    S = a[u].edgeOffset;
                  S ||
                    ((S = G(h, this.container)),
                    (a[u].edgeOffset = S),
                    c && (a[u].boundingClientRect = H(h, r)));
                  var O = u < a.length - 1 && a[u + 1],
                    C = 0 < u && a[u - 1];
                  O &&
                    !O.edgeOffset &&
                    ((O.edgeOffset = G(O.node, this.container)),
                    c && (O.boundingClientRect = H(O.node, r))),
                    p !== this.index
                      ? (t && W(h, t),
                        this.axis.x
                          ? this.axis.y
            ...
            },
            {
              key: 'render',
              value: function() {
                var e = r.withRef ? this.wrappedInstance : null;
                return a.createElement(
                  oe.Provider,
                  {value: this.sortableContextValue},
                  a.createElement(t, l({ref: e}, I(this.props, ne))),
                );
              },
            },
            {
  ...
  function se(t) {
    ...
    return (
        ...
        return (
          ...
          f(i, [
            ...
            },
            {
              ...
              value: function() {
                var e = o.withRef ? this.wrappedInstance : null;
                return a.createElement(t, l({ref: e}, I(this.props, ae)));
              },
            },
          ]),
          i
      ...
      c(e, 'displayName', j('sortableElement', t)),
      c(e, 'contextType', oe),
      c(e, 'propTypes', ie),
  ...
  (e.SortableContainer = re),
    (e.sortableContainer = re),
    (e.SortableElement = se),
    (e.sortableElement = se),
    (e.SortableHandle = $),
    (e.sortableHandle = $),
